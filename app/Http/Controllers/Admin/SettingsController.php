...
class SettingsController extends Controller
{
  ...
  public function updatebotswt(Request $request){
    ...
    Settings::where('id', $request['id'])
        ...
        'referral_commission6'=>$request['ref_commission6'],
        'referral_commission7'=>$request['ref_commission7'],
        'referral_commission8'=>$request['ref_commission8'],
        'referral_commission9'=>$request['ref_commission9'],
        'referral_commission10'=>$request['ref_commission10'],
        'referral_commission11'=>$request['ref_commission11'],
        'referral_commission12'=>$request['ref_commission12'],
        'referral_commission13'=>$request['ref_commission13'],
        'referral_commission14'=>$request['ref_commission14'],
...
//added by vivekchand
  public function updateCashback(Request $request){
   ...
   Settings::where('id', '1')
        ->update([
        'cashbackper'=>$request['cashbackper'],
        ]);
        return redirect()->back()
        ->with('message', 'Action Sucessful');
}
