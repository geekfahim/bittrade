                    ...
                    <table class="table table-cart">
                        ...
                        <tbody>
                                ...
                                <td class="product-col">
                                    <figure class="product-image-container">
                                        <a href="{{ route('shop.product') }}" class="product-image">
                                            <img src="{{ asset('public/assets/images/products/product-4.jpg') }}"
                                                alt="product">
                                        </a>
                                    </figure>
                                    <h2 class="product-title">
                                        <a href="{{ route('shop.product') }}">Men Watch</a>
                                    </h2>
                                </td>
                                <td>$17.90</td>
                                <td>
                            ...
                            <tr class="product-row">
                                <td class="product-col">
                                    <figure class="product-image-container">
                                        <a href="{{ route('shop.product') }}" class="product-image">
                                            <img src="{{ asset('public/assets/images/products/product-3.jpg') }}"
                                                alt="product">
                                        </a>
                                    </figure>
                                    <h2 class="product-title">
                                        <a href="{{ route('shop.product') }}">Computer Mouse</a>
                                    </h2>
                                </td>
                                <td>$8.90</td>
                                <td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="clearfix">
                                    <div class="float-left">
                                        <a href="{{ route('shop.category') }}" class="btn btn-outline-secondary">Continue
                                            Shopping</a>
                                    </div><!-- End .float-left -->
            ...
            <div class="col-lg-4">
                <div class="cart-summary">
                    ...
                    <div class="checkout-methods">
                        <a href="{{ route('shop.checkout') }}" class="btn btn-block btn-sm btn-primary">Go to Checkout</a>
