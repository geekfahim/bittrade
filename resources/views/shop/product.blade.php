            ...
            <div class="row">
                <div class="col-md-5 product-single-gallery">
                        ...
                        <div class="product-single-carousel owl-carousel owl-theme">
                            <div class="product-item">
                                <img class="product-single-image"
                                    src="{{ asset('public/assets/images/products/zoom/product-1.jpg') }}"
                                    data-zoom-image="{{ asset('public/assets/images/products/zoom/product-1-big.jpg') }}" />
                            </div>
                            <div class="product-item">
                                <img class="product-single-image"
                                    src="{{ asset('public/assets/images/products/zoom/product-2.jpg') }}"
                                    data-zoom-image="{{ asset('public/assets/images/products/zoom/product-2-big.jpg') }}" />
                            </div>
                            <div class="product-item">
                                <img class="product-single-image"
                                    src="{{ asset('public/assets/images/products/zoom/product-3.jpg') }}"
                                    data-zoom-image="{{ asset('public/assets/images/products/zoom/product-3-big.jpg') }}" />
                            </div>
                            <div class="product-item">
                                <img class="product-single-image"
                                    src="{{ asset('public/assets/images/products/zoom/product-4.jpg') }}"
                                    data-zoom-image="{{ asset('public/assets/images/products/zoom/product-4-big.jpg') }}" />
                            </div>
                        </div>
                    ...
                    <div class="prod-thumbnail owl-dots" id='carousel-custom-dots'>
                        <div class="owl-dot">
                            <img src="{{ asset('public/assets/images/products/zoom/product-1.jpg') }}" />
                        </div>
                        <div class="owl-dot">
                            <img src="{{ asset('public/assets/images/products/zoom/product-2.jpg') }}" />
                        </div>
                        <div class="owl-dot">
                            <img src="{{ asset('public/assets/images/products/zoom/product-3.jpg') }}" />
                        </div>
                        <div class="owl-dot">
                            <img src="{{ asset('public/assets/images/products/zoom/product-4.jpg') }}" />
                        </div>
                    </div>
                ...
                <div class="col-md-7 product-single-details">
                    ...
                    <div class="product-action">
                        ...
                        <a href="{{ route('shop.cart') }}" class="btn btn-dark add-cart icon-shopping-cart"
                                ...
                                <ol class="comment-list">
                                    <li class="comment-container">
                                        <div class="comment-avatar">
                                            <img src="{{ asset('public/assets/images/avatar/avatar1.jpg') }}" width="65"
                                        ...
                                        <div class="comment-box">
                                            ...
                                            <div class="comment-info mb-1">
                                                <h4 class="avatar-name">John Doe</h4> - <span class="comment-date">Novemeber
                                                    15, 2019</span>
                                    ...
                                    <li class="comment-container">
                                        <div class="comment-avatar">
                                            <img src="{{ asset('public/assets/images/avatar/avatar2.jpg') }}" width="65"
                                                height="65" alt="avatar" />
                                        </div><!-- End .comment-avatar-->
                                    ...
                                    <li class="comment-container">
                                        <div class="comment-avatar">
                                            <img src="{{ asset('public/assets/images/avatar/avatar3.jpg') }}" width="65"
                                                height="65" alt="avatar" />
                                        </div><!-- End .comment-avatar-->
        ...
        <div class="products-section pt-0">
            ...
            <div class="products-slider owl-carousel owl-theme dots-top">
                <div class="product-default inner-quickview inner-icon">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title">
                            <a href="{{ route('shop.home') }}">Product Short Name</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="{{ route('shop.home') }}">
                            <img src="{{ asset('public/assets/images/products/product-9.jpg') }}">
                        </a>
                        <div class="label-group">
