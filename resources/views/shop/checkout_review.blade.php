                            ...
                            <tbody>
                                    ...
                                    <td class="product-col">
                                        <figure class="product-image-container">
                                            <a href="{{ route('shop.product') }}" class="product-image">
                                                <img src="{{ asset('public/assets/images/products/product-1.jpg') }}"
                                                    alt="product">
                                            </a>
                                        </figure>
                                        <div>
                                            <h2 class="product-title">
                                                <a href="{{ route('shop.product') }}">USB Flash</a>
                                            </h2>
                                ...
                                <tr>
                                    <td class="product-col">
                                        <figure class="product-image-container">
                                            <a href="{{ route('shop.product') }}" class="product-image">
                                                <img src="{{ asset('public/assets/images/products/product-2.jpg') }}"
                                                    alt="product">
                                            </a>
                                        </figure>
                                        <div>
                                            <h2 class="product-title">
                                                <a href="{{ route('shop.product') }}">Inline Headset</a>
                                            </h2>
                ...
                <div class="checkout-payment">
                    ...
                    <div class="form-group-custom-control">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="change-bill-address">My billing and shipping address
                                are the same</label>
