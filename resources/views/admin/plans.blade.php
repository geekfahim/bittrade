    ...
    @section('content')
									...
									<div class="modal-content bg-{{Auth('admin')->User()->dashboard_style}}">
										...
										<div class="modal-body">
											<form role="form" method="post" action="{{ route('updateplan') }}">
												...
												<select class="form-control invDuretion text-{{$text}} bg-{{Auth('admin')->User()->dashboard_style}}" name="expiration">
												...
												<input type="text" name="invDurationValue" class="text invDurationValue" value="{{$plan->expiration}}" required >
		...
		<script>
			$(document).ready(function(){
				...
				$('.invDurationValue').hide();
                $(document).on('change','.invDuretion',function(){
                    var id = $(this).val();
                    $('.invDurationValue').hide();
                    if(id == 'manual'){
                        $('.invDurationValue').show();
                    }
                })
