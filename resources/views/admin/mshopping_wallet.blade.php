		...
		<div class="main-panel">
			<div class="content bg-{{Auth('admin')->User()->dashboard_style}} ">
				<div class="page-inner">
					<div class="mt-2 mb-4">
					<h1 class="title1 text-{{$text}}">Manage clients shopping wallet transactions</h1>
					</div>
									...
									<tbody> 
										...
										<tr> 
											...
											<a href="#" class="btn btn-{{$text}} btn-sm m-1" data-toggle="modal" data-target="#popModal{{$deposit->id}}" title="View payment proof">
												...
												<a href="{{ url('admin/dashboard/delshopping_wallet') }}/{{$deposit->id}}" class="m-1 btn btn-danger btn-sm">Delete</a>
												@if($deposit->status == 1) 
												<a class="btn btn-success btn-sm" href="#">Processed</a>
												@else
												<a class="btn btn-primary btn-sm" href="{{ url('admin/dashboard/pshopping_wallet') }}/{{$deposit->id}}">Process</a>
												@endif
