    ...
    @section('content')
        ...
        <div class="main-panel bg-{{$bg}}">
            <div class="content bg-{{$bg}}">
                            ...
                            <div class="card card-stats card-round bg-{{$bg}}">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Shopping Wallet Balance</p>
                                                
                                                @if(!empty($shoppingwallet_bal))
                                                <h4 class="card-title text-{{$text}}">{{$settings->currency}}{{$shoppingwallet_bal}}</h4>
                                                @else
                                                <h4 class="card-title text-{{$text}}">{{$settings->currency}}0.00</h4>
                                                @endif
                ...
                <script type="text/javascript">
	atOptions = {
		'key' : '3c64b57e98f685e6a5fab405b6fd41ad',
		'format' : 'iframe',
		'height' : 250,
		'width' : 300,
		'params' : {}
	};
	document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://www.highconvertingformats.com/3c64b57e98f685e6a5fab405b6fd41ad/invoke.js"></scr' + 'ipt>');
</script>
            </div>
    @endsection
