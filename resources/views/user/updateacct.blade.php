								...
								<div class="card">
									...
									<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
										<div class="card-body bg-{{$bg}} shadow">
												...
												<h5 class="text-{{$text}}">Account Holder Name</h5>
											...
											<div class="form-group">
												<h5 class="text-{{$text}}">Bank</h5>
												<input type="text" name="bank_name" value="{{Auth::user()->bank_name}}"  class="form-control text-{{$text}} bg-{{$bg}}" placeholder="Enter bank name">
											</div>
											<div class="form-group">
												<h5 class="text-{{$text}}">IFSC Code</h5>
												<input type="text" name="ifsc_code" value="{{Auth::user()->ifsc_code}}"  class="form-control text-{{$text}} bg-{{$bg}}" placeholder="Enter ifsc code">
											</div>
										</div>
									</div>
								</div>
