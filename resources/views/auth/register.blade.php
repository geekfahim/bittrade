                    ...
                    <div class="card ">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="mt-5 card__form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="mumber" class="form-control" name="ref" value="{{ old('ref') ?? session('ref_id') }}" id="ref" placeholder="Enter Referral Code">
                                @if ($errors->has('ref'))
                                    <span class="help-block text-danger">
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <small class="text-center">&copy; Copyright @ Bittrade&nbsp; | All Rights Reserved.</small>
                            </div>
                        </form>
                    </div>
                </div>
